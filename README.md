...
# 🎮 Twisted Tower — Community Edition
...
Twisted Tower is a co-op horror game where up to four players ascend a procedurally generated tower filled with hostile creatures, hidden loot, and escalating danger. Each floor introduces new hazards as teams race to reach the top and escape alive. This Community Edition is a standalone build presented as a self-contained package: no storefront required, no additional software required, and ready to play immediately.

This build is for horror and co-op fans who want a self-contained offline version of Twisted Tower they can play immediately with friends over LAN or direct connection.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1575990/1955548d6cceb3056bb7263e8a0b6b2882c919b1/ss_1955548d6cceb3056bb7263e8a0b6b2882c919b1.1920x1080.jpg?t=1787251359" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1575990/c55fc9a3982353250e2ef6148b3f0e3332ca55d5/ss_c55fc9a3982353250e2ef6148b3f0e3332ca55d5.1920x1080.jpg?t=1787251359" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1575990/f24c4c9c133b204c6125f788c2f04807b1b1fe31/ss_f24c4c9c133b204c6125f788c2f04807b1b1fe31.1920x1080.jpg?t=1787251359" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🗼 **Procedural Tower** — Every run generates a new tower layout with shifting rooms, traps, and loot placements.
- 👥 **4-Player Co-op** — Team up with up to four players online, or connect via LAN and direct P2P sessions.
- 👹 **Unique Monsters** — Each floor introduces distinct creatures with their own behaviors, tells, and hunting patterns.
- 🎙️ **Proximity Voice Chat** — In-game voice communication that carries based on player distance for tense, immersive coordination.
- 💰 **Loot and Extraction** — Gather valuables during the ascent and decide when to push higher or cut your losses and escape.
- 📦 **Self-Contained Package** — Standalone build with all dependencies included — no storefront required and no additional software required.
- 🌐 **LAN and Direct Connect** — LAN and direct P2P connection supported for offline-friendly play with friends.
- 🎚️ **Scalable Difficulty** — Difficulty and monster density adapt to team size and progress, from cautious climbs to high-stakes runs.
...
| **Processor** | Intel Core i5-4460 / AMD FX-8350 | Intel Core i5-10400 / AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 1050 Ti / AMD Radeon RX 560 (4 GB VRAM) | NVIDIA GeForce GTX 1660 Super / AMD Radeon RX 5600 XT (6 GB VRAM) |
| **Storage** | 10 GB available space | 10 GB available space on SSD |
| **Additional** | Broadband internet connection or LAN for multiplayer; microphone recommended for voice chat | Broadband internet connection or LAN for multiplayer; headset with microphone for proximity voice |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\TwistedTower\Saved`
